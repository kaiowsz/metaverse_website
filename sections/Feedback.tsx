    ...
    <section className={`${styles.paddings} relative z-10`}>
      ...
      >
        ...
        >
          ...
          <p className="mt-[8px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white">&quot;With the development of today&apos;s technology, Metaverse is very useful for today&apos;s work, or can be called web 3.0. By using Metaverse you can use it as anything.&quot;</p>
        </motion.div>
